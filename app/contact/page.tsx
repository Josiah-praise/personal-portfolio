...
export const metadata = {
  ...
  description:
    'Get in touch with me to discuss new projects, creative ideas, or opportunities to collaborate.',
};
...
export default function ContactPage() {
  return (
    <div className="relative min-h-screen">
      ...
      <div className="container relative z-10 mx-auto px-4 py-12 animate-fade-in">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-1 mb-6">
                ...
                <p className="text-base text-muted-foreground">
                  Fill out the form below with your details and I&apos;ll get back to you as soon as
                  possible
                </p>
              </div>
              <ContactForm />
