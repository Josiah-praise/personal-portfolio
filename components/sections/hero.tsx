...
export function Hero() {
  ...
  return (
    ...
    >
      {/* DotGrid Background - extends to top of viewport */}
      <div className="fixed inset-0 -z-10">
        <DotGrid
          dotSize={4}
          gap={20}
          baseColor={isDark ? '#444444' : '#d0d0d0'}
        ...
        <div className="relative rounded-none border border-black/15 bg-white/20 p-8 shadow-lg backdrop-blur-sm dark:border-white/15 dark:bg-black/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left space-y-6 animate-fade-in">
              <div className="inline-flex items-center gap-2 px-5 py-1.5 rounded-full border border-white/40 bg-white/25 text-sm font-medium text-foreground/80 shadow-[0_12px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl">
              ...
              <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                ...
                <span className="text-foreground font-semibold">blockchain solutions</span>, with a
                focus on <span className="text-foreground font-semibold">backend architecture</span>{' '}
                and systems design. Passionate about creating robust, efficient applications that
              ...
              <div className="flex gap-4 justify-center lg:justify-start pt-6">
                <a
                  ...
                  className="p-3 rounded-full border border-white/30 bg-white/20 text-foreground shadow-[0_10px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl hover:bg-white/30 transition-all"
                  aria-label="GitHub"
                >
            ...
            <div className="order-1 lg:order-2 flex justify-center animate-fade-in-delay">
              <div className="relative animate-float">
                {/* Decorative glow */}
                <div className="absolute -inset-6 rounded-full bg-white/20 blur-3xl opacity-60" />

                {/* Image container */}
                <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border border-white/30 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
                  <Image
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-b from-black/5 via-black/40 to-black/70 pointer-events-none" />
                </div>
              </div>
            </div>
          </div>
