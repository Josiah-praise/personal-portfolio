...
- [Personal-Portfolio Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [SkillCategory](./data-models.md#skillcategory)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [ContactFormData](./data-models.md#contactformdata)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [SocialLink](./data-models.md#sociallink)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
  ...
  - [Components](./components.md)
    ...
    - [Contact API Route](./components.md#contact-api-route)
    - [MDX Content System](./components.md#mdx-content-system)
    - [UI Component Library (shadcn/ui)](./components.md#ui-component-library-shadcnui)
    - [Analytics & Monitoring](./components.md#analytics-monitoring)
    - [Component Diagrams](./components.md#component-diagrams)
  - [Core Workflows](./core-workflows.md)
    - [User Views Project Case Study](./core-workflows.md#user-views-project-case-study)
    - [Contact Form Submission](./core-workflows.md#contact-form-submission)
    - [Content Build & Deployment](./core-workflows.md#content-build-deployment)
